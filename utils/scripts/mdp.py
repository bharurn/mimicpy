class MDP:
    ...
    def __str__(self):
        ...
        val = f'; Gromacs MD parameters for {self.name} run generated by MiMiCPy\n'
        
        data = [attr for attr in dir(self) if not callable(getattr(self, attr)) and attr.startswith('__') and attr != 'name']
