...
class MM(Run):
    ...
    def prepareTopology(self, histidine=[]):
        ...
        host.write(self.protein.pdb+self.protein.water, "confin.pdb")
        ...
        for ligname, lig in self.protein.ligands.items():
            ...
            host.write(lig.posre, f"posre_{lig.name}.itp")
    ...
    def prepareBox(self, genion_mdp = mdp.MDP.defaultGenion()):
        ...
        host.write(str(genion_mdp), "ions.mdp")
